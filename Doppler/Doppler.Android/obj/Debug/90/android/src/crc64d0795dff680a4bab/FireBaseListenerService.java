...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Doppler.Droid.FireBaseService.FireBaseListenerService, Doppler.Android", FireBaseListenerService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == FireBaseListenerService.class)
			mono.android.TypeManager.Activate ("Doppler.Droid.FireBaseService.FireBaseListenerService, Doppler.Android", "", this, new java.lang.Object[] {  });
	}
