...
namespace Doppler.REST.Services
{
    public class SocialService
    {
        ...
        {
            return await this.repository.GetUserConversationAsync(this.identityService.AuthenticatedUser, id);
        }
        ...
        {
            return await this.repository.GetConversationMembersPhones(id);
        }
    }
}
